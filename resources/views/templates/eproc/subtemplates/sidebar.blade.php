  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      @if(auth()->user()->level == 1)
        ...
        <li><a class="nav-link" href="{{ route('eproc.superadmin.barang.index') }}"><i class="far fa-square"></i><span>Management Pengadaan</span></a></li>
        @endif
        ...
        <li><a class="nav-link" href="{{ route('eproc.admin.barang.index') }}"><i class="far fa-square"></i><span>Management Pengadaan</span></a></li>
      @endif
    </ul>
  </aside>
</div>