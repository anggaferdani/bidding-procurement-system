  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      @if(auth()->user()->level == 1)
        ...
        <li><a class="nav-link" href="{{ route('eproc.superadmin.barang.index') }}"><i class="far fa-square"></i><span>M. Pengadaan Barang</span></a></li>
      ...
      @if(auth()->user()->level == 2)
        ...
        <li class="menu-header">Pengadaan Barang</li>
        <li><a class="nav-link" href="{{ route('eproc.admin.barang.index') }}"><i class="far fa-square"></i><span>M. Pengadaan Barang</span></a></li>
